...
public class ListAdapter extends BaseAdapter {
	...
	public ListAdapter(Context _context, LinkedList< BusObject > _list) {
	...
	public View getView(int _position, View _convertView, ViewGroup _parent) {
		...
		if (_convertView == null) {
			_convertView = this.inflater.inflate(R.layout.row_list, null);
		}
		
		BusObject obj = list.get(_position);
		if (obj != null) {
			TextView content = (TextView) _convertView.findViewById(R.id.row_list_Content);
			if (content != null) {
