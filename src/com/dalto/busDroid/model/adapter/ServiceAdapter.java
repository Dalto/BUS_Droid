...
public class ServiceAdapter extends BaseAdapter {
	...
	public ServiceAdapter(Context _context, LinkedList< BusObject > _list) {
	...
	public View getView(int _position, View _convertView, ViewGroup _parent) {
		...
		if (_convertView == null) {
			_convertView = this.inflater.inflate(R.layout.row_service, null);
		}
		
		BusObject obj = list.get(_position);
		if (obj != null) {
			TextView content = (TextView) _convertView.findViewById(R.id.row_service_content);
			if (content != null) {
